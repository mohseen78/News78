package com.example.abdulmohseen.news78.adapter;
...
import com.example.abdulmohseen.news78.view.ArticleActivity;
...
public class DataAdapter extends RecyclerView.Adapter<DataAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(DataAdapter.ViewHolder holder, int position) {
        ...
        if (title.endsWith("- Times of India")) {
            title = title.replace("- Times of India", "Abdul Mohseen");
        ...
        holder.publish_time.setText(UtilityMethods.manipulateDateFormat(articles.get(position).getPublishedAt()));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View view) {
            ...
            name = view.findViewById(R.id.section);
            publish_time = view.findViewById(R.id.published_time);
